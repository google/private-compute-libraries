...
// Incorrectly passes @DataCacheStore an invalid TTL string, not matching the expected format.
@ChronicleData
@DataCacheStore(ttl = "4 score & 7 years", maxItems = 1000)
public class ErroneousJavaTypeForInvalidTtl {
  private final String name;

  public ErroneousJavaTypeForInvalidTtl(String name) {
    this.name = name;
  }
