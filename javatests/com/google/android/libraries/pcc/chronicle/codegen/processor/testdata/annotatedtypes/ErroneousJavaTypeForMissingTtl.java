...
// Incorrectly omits TTL from @DataCacheStore.
@ChronicleData
@DataCacheStore(maxItems = 1000)
public class ErroneousJavaTypeForMissingTtl {
  private final String name;

  public ErroneousJavaTypeForMissingTtl(String name) {
    this.name = name;
  }
