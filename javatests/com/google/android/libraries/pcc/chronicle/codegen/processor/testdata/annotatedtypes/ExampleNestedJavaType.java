...
@ChronicleData
public class ExampleNestedJavaType {
  private final String name;
  private final ExampleJavaType nested;

  public ExampleNestedJavaType(String name, ExampleJavaType nested) {
    this.name = name;
    this.nested = nested;
  }
  ...
  public ExampleJavaType getNested() {
    return nested;
  }
}
