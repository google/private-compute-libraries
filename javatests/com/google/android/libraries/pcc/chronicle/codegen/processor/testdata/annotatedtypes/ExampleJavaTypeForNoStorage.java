...
// Using @ChronicleData without a storage annotation like @DataCacheStore is allowed.
@ChronicleData
public class ExampleJavaTypeForNoStorage {
  private final String name;

  public ExampleJavaTypeForNoStorage(String name) {
    this.name = name;
  }
