...
// Incorrectly annotates a generic [Connection] with @ChronicleConnection, instead of a
// [ReadConnection] or a [WriteConnection].
@ChronicleConnection(dataClass = ExampleJavaType.class)
public interface ErroneousJavaGenericConnection extends Connection {}
