...
@ChronicleConnection(dataClass = ExampleJavaType.class)
public interface ExampleJavaTypeReadWriter extends ReadConnection, WriteConnection {
  public ExampleJavaType getExampleJavaType();
  public void writeExampleJavaType(ExampleJavaType exampleJavaType);
}
