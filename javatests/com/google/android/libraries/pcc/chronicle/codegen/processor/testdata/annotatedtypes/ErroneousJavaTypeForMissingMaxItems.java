...
// Incorrectly omits maxItems from @DataCacheStore.
@ChronicleData
@DataCacheStore(ttl = "2d")
public class ErroneousJavaTypeForMissingMaxItems {
  private final String name;

  public ErroneousJavaTypeForMissingMaxItems(String name) {
    this.name = name;
  }
