...
/** Implementation of [LensBodyBuilder] intended for scalar oneof fields. */
object ProtoMapLensBodyBuilder : BaseProtoLensBodyBuilder() {
  override fun supportsField(type: Type, field: FieldEntry): Boolean =
    type.tooling == Type.Tooling.PROTO && field.category is FieldCategory.MapValue
  ...
  override fun buildSetterBuilderCode(
    ...
    return CodeBlock.builder()
      ...
      .addStatement("putAll${field.name.capitalize()}($newValueParamName)")
      .build()
  }
}
