...
internal class ServerLocalPeopleReader(private val peopleStore: PeopleStore) : PeopleReader {
  override suspend fun fetchAll(): List<Person> =
    peopleStore.fetchAll().toList().flatten().map { it.entity }
}
